...
class BookLibrary:
    ...
    def amazon_price_and_link(self):
        ...
        try:
            amazon_response = requests.get(self.amazon_url, headers=headers)
        ...
        if amazon_response.status_code == 200:
            ...
            if book_in_amazon:
                ...
                try:
                    amazon_book_response = requests.get(book_url_in_ama, headers=headers)
    ...
    def reviews_from_goodreads(self):
        review_list =[]
        try:
            good_reads_response = requests.get(self.good_reads_url, headers=headers)
        ...
        if good_reads_response.status_code == 200:
            ...
            if good_reads_response:
                ...
                try:
                    good_reads_book = requests.get(book_url_in_gr, headers=headers)
